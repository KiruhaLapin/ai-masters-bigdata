...
tf_review = HashingTF(inputCol="filtered_review_words", outputCol="raw_review_features", numFeatures=1000)
...
regressor = LinearRegression(labelCol="overall", featuresCol="features")
